...
export const BoardSortModal = ({
  ...
  const sortOptions =
    boardType === '공지사항' ? NOTICE_SORT_OPTIONS : INQUIRY_SORT_OPTIONS
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-mobile bg-white rounded-t-2xl z-[101]">
        {/* Header */}
        ...
        <div className="px-5 py-2">
          <div className="divide-y divide-gray-100">
            {sortOptions.map((option) => (
              ...
              >
                <span
                  className={`text-base font-medium ${selectedSort === option.id ? 'text-gray-900' : 'text-gray-600/70'}`}
                >
                  {option.label}
                </span>
