...
export const ManagerReservationsClient = ({ initialReservations }: ManagerReservationsClientProps) => {
  ...
  const updateReservationStatus = async (id: string, newStatus: Partial<Reservation>) => {
    try {
      ...
      <div className="flex flex-col gap-4 px-5">
        <div className="flex gap-10">
          ...
          >
            ...
            {activeTab === 'upcoming' && <div className="h-0.5 w-full bg-[#4DD0E1]" />}
          </button>
          <button
          ...
          >
            ...
            {activeTab === 'past' && <div className="h-0.5 w-full bg-[#4DD0E1]" />}
          </button>
        </div>
      </div>
        ...
        {filteredReservations.length > 0 ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-6 rounded-2xl bg-white">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100">
              <Image src="/icons/calendar-check.svg" alt="업무 없음" width={32} height={32} />
            </div>
            <div className="text-center">
              <p className="text-lg font-bold text-gray-800">
                {activeTab === 'upcoming' ? '예정된 업무가 없습니다' : '지난 업무가 없습니다'}
              </p>
