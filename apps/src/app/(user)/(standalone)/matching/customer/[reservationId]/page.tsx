...
const DynamicIcon = ({
  icon,
  ...props
}: { icon: IconType } & { className?: string; size?: number }) => {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="pt-0 p-4 pb-20 min-h-[calc(100vh-64px)]">
        <div className="w-full max-w-mobile mx-auto min-h-screen flex flex-col bg-white">
          ...
          <div className="px-4 py-6">
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center gap-1 mb-4">
                {Array(Math.floor(manager.rating))
                  .fill(null)
                  .map((_, index) => (
                    <DynamicIcon
                      key={index}
                ...
                <span className="text-gray-600 ml-2">
                  {manager.rating}점 (리뷰 {manager.reviewCount}개)
                </span>
              </div>
            </div>
          </div>
          ...
          <section className="px-4 py-6 border-t">
            ...
            <p className="text-gray-700 leading-relaxed">
              안녕하세요! 매칭 요청 감사합니다. 고객님의 요구사항을 꼼꼼히
              확인했습니다. 최선을 다해 서비스를 제공하도록 하겠습니다.
            </p>
          </section>
        ...
        {/* Bottom Buttons */}
        <div className="fixed bottom-0 w-full max-w-mobile bg-white border-t border-slate-200">
          <div className="px-4">
