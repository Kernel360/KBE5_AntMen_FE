    ...
    <article className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
      ...
      <footer className="flex gap-3">
        ...
        <Link
          ...
          className="flex-1 h-11 bg-primary rounded-[22px] text-sm font-bold text-white hover:bg-[#0ca8c0] transition-colors flex items-center justify-center"
