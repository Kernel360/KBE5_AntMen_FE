...
export const MorePageUI = ({ user }: MorePageUIProps) => {
  const menuItems = [
    ...
    { icon: '/icons/bell.svg', label: 'Antwork에서 알림', href: '/notifications' },
    { icon: '/icons/credit-card.svg', label: '결제수단 관리', href: '/payment' },
    { icon: '/icons/send.svg', label: '친구 초대하기', href: '/invite' },
    { icon: '/icons/gift.svg', label: '프로모션 코드와 선물', href: '/promotions' },
